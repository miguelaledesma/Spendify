  ...
  return (
    <div class="w-full bg-white lg:w-6/12 xl:w-5/12">
      <div class="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24">
        <h4 class="w-full text-3xl font-bold">Add Expense</h4>
        ...
        <form class="relative w-full mt-10 space-y-8" onSubmit={handleSubmit}>
          <div class="relative">
            <label class="font-medium text-gray-900">Expense</label>
            <input
              type="text"
              value={title}
              name={"title"}
          ...
          <div class="relative">
            <label class="font-medium text-gray-900">Amount</label>
            <input
              value={amount}
              type="text"
              name={"amount"}
